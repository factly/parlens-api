...
export const resolvers = {
  Query: {
    ...
    member: (_, { name, gender, dob, marital_status, sons, daughters, education, profession, term, party, from, type, session }) => {
      let filterList = {}
      ...
      if(type) filterList['wins.type'] = type
    ...
    question: (_, { subject, type, que, answer, asked, ministry}) => {
      var filterList = {}
