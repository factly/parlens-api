...
export const resolvers = {
  Query: {
    ...
    member: (_, {
      name, gender, dob, marital_status, sons, daughters, education, profession, term, party, from, house, session,
    }) => {
      const filterList = {};
    ...
    question: (_, {
      subject, type, que, answer, asked, ministry, name, gender, dob, marital_status, sons, daughters, education, profession, term, party, from, house, session,
    }) => {
  ...
  Mutation: {
    ...
    createMember: async (_, {
      name, gender, dob, birth_place, marital_status, sons, daughters, education, profession, party, from, house, session,
    }) => {
      const temp = [];
      ...
      const member = new Members({
        name, gender, dob, birth_place, marital_status, sons, daughters, education, profession: temp, wins: temp2,
      });
      await member.save();
      return member;
    },
    createQuestion: async (_, {
      subject, type, question, asked, answer, ministry, date,
    }) => {
      const questions = new Questions({
        subject, type, question, asked: [asked], answer, ministry, date,
      });
