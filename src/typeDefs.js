...
export const typeDefs = gql`
  type Query {
    members: [Member!]!  
    member(name: String, gender: String, dob: String, marital_status: String, sons: Int, daughters: Int, education: String, profession: String, term: Int, party: String, from: String, type: String, session: Int): [Member]!
    parties: [Party!]!
    constituencies: [Constituency!]!
    questions: [Question!]!
    question(subject: String, type: String, question: String, asked: String, answer: String, ministry: String): [Question!]!
  }
  type Mutation {
